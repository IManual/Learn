...
public static class AssetBundleEditor
{
    ...
    static void AuotBuildAll()
    {
        ...
        BuildPipeline.BuildAssetBundles(outPath, BuildAssetBundleOptions.None, GetBuildTarget(Application.platform));
    ...
    private static void MarkAllResources(string fullPath, string assetName)
    {
        ...
        int tmpindex = assetName.IndexOf('/');
        string fileName = tmpindex!=-1? assetName.Substring(0, assetName.IndexOf('/')) : assetName.Substring(0, assetName.IndexOf('.'));
